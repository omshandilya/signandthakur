...
# Base Directory pointing to the project root (contains manage.py)
...
SECRET_KEY = env('DJANGO_SECRET_KEY', default='django-insecure-dev-fallback-key-replace-in-env')
...
# Custom User Model (Configured from Day One)
